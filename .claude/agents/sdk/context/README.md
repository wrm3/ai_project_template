...
```python
from .claude.agents.sdk.context import ContextManager, AgentMode
...
```python
from .claude.agents.sdk.context import ContextManager
...
```python
from .claude.agents.prompt_based.context_adapter import ContextAdapter
...
```python
from .claude.agents.sdk.context import ContextManager
from .claude.agents.sdk.context.utils import analyze_context_performance, export_context_report
...
```bash
# Dry run first
python -m claude.agents.sdk.context.manager cleanup --dry-run

# Archive expired contexts (>72 hours)
python -m claude.agents.sdk.context.manager cleanup

# Delete old archived contexts (>30 days)
python -m claude.agents.sdk.context.manager delete-old --days 30
```
...
```python
from claude.agents.sdk.context.utils import validate_context
...
from claude.agents.sdk.context.utils import cleanup_old_contexts
