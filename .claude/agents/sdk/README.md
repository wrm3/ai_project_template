...
- `model` (str): Claude model (default: "claude-sonnet-4-5-20250929")
...
- **Task 052**: Full task specification in `.fstrent_spec_tasks/tasks/task052_anthropic_agent_sdk_integration.md`
