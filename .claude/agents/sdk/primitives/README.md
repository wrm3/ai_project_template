# Claude Code Primitives Integration for Agent SDK

This module provides Agent SDK agents with access to Claude Code's core primitives:
...
The primitives system enables SDK agents to leverage Claude Code's full capabilities while maintaining structured context sharing and state management.
...
Invoke Claude Code plugins (MCP tools) from your agent:
...
Execute Claude Code slash commands programmatically:
...
- **Task File**: `.fstrent_spec_tasks/tasks/task052_anthropic_agent_sdk_integration.md`
