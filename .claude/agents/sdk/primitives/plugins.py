...
Enables SDK agents to invoke Claude Code plugins (MCP tools) and store results in context.
...
class Plugins:
    ...
    Provides agents with access to MCP tools via Claude Code's plugin system.
    ...
    def call(self, plugin_name: str, **params) -> Dict[str, Any]:
        """
        Invoke a Claude Code plugin (MCP tool)
        ...
        try:
            ...
            # NOTE: In actual implementation, this would use Claude Code's
    ...
    def list_available(self) -> List[str]:
        ...
        """
        # NOTE: In actual implementation, this would query Claude Code's
    ...
    def _invoke_plugin(self, plugin_name: str, params: Dict[str, Any]) -> Any:
        """
        Internal method to invoke plugin via Claude Code's MCP client

        NOTE: This is a placeholder for the actual MCP invocation.
        In production, this would use Claude Code's internal APIs.
        ...
        # In actual implementation, this would call Claude Code's MCP client
