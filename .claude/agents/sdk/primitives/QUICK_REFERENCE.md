# Claude Code Primitives - Quick Reference
...
**Common Commands**: `/review-pr`, `/status`, `/run-tests`, `/new-task`
...
- **Task**: `.fstrent_spec_tasks/tasks/task052_anthropic_agent_sdk_integration.md`
